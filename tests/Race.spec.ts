...
describe('Race', () => {
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const counterBefore = await race.getCounter();
            ...
            const increaseResult = await race.sendIncrease(increaser.getSender(), {
                increaseBy,
                value: toNano('0.05'),
            });
            ...
            const counterAfter = await race.getCounter();
